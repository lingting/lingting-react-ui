...
import {type Theme, type TypographyVariant, useTheme, useTypography} from "lingting-react-ui"
...
const TypographyPage = lazy(() =>
    import("./TypographyPage").then((module) => ({default: module.TypographyPage}))
)
...
export function ComponentsApp() {
    ...
    const {persist: typographyPersist, setPersist: setTypographyPersist, setTypography, typography} = useTypography()
    const Page = page === "extension"
        ? ExtensionPage
        : page === "shadcn"
            ? ShadcnPage
            : TypographyPage
    ...
    return (
        <div className="min-h-screen">
            ...
            <main className="mx-auto w-full max-w-5xl p-6">
                ...
                <p className="mb-6 text-sm text-muted-foreground">当前排版：{typography}</p>
