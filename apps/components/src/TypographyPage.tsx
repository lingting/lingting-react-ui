...
const longText =
  "排版组件支持通过省略配置控制长文本展示，在需要时允许用户展开完整内容，并在不同排版方案中保持一致的层级和节奏。"
  ...
  return (
    <section className="typography-content space-y-8">
      ...
      <div className="space-y-3">
        ...
        <Paragraph>
          <Text strong>强调文本</Text>、<Text italic>斜体文本</Text>、
          <Text underline>下划线</Text>、<Text delete>删除线</Text>、
          <Text mark>标记文本</Text>、<Code>const name = "Lingting"</Code>、
      ...
      <Typography.Paragraph type="secondary">
        同时支持具名组件和 <Typography.Code>Typography.Title</Typography.Code>{" "}
        等复合组件 API。
